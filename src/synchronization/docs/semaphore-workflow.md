...
| `pies_meat` | 0 | Client with vegetables waits for pies and meat. |
| `meat_veg` | 0 | Client with pies waits for meat and vegetables. |
| `veg_pies` | 0 | Client with meat waits for vegetables and pies. |
